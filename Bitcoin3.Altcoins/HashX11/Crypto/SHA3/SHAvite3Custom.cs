...
namespace Bitcoin3.Altcoins.HashX11.Crypto.SHA3.Custom
{
    ...
    //{
    //    public SHAvite3_224()
    //        : base(Bitcoin3.Altcoins.HashX11.HashSize.HashSize224)
    //    {
    //    }
    //}
    ...
    //{
    //    public SHAvite3_256()
    //        : base(Bitcoin3.Altcoins.HashX11.HashSize.HashSize256)
    //    {
    //    }
    //}
    ...
    {
        public SHAvite3_384()
            : base(Bitcoin3.Altcoins.HashX11.HashSize.HashSize384)
        {
        }
    }
    ...
    {
        public SHAvite3_512()
            : base(Bitcoin3.Altcoins.HashX11.HashSize.HashSize512)
        {
        }
    }
    ...
    internal abstract class SHAvite3Base : BlockHash, ICryptoNotBuildIn
    {
        ...
        public SHAvite3Base(Bitcoin3.Altcoins.HashX11.HashSize a_hash_size, int a_block_size)
    ...
    //    public SHAvite3_256Base(Bitcoin3.Altcoins.HashX11.HashSize a_hash_size)
    //        : base(a_hash_size, 64)
    //    {
    //        Initialize();
    //    }
    ...
    internal abstract class SHAvite3_512Base : SHAvite3Base
    {
        ...
        public SHAvite3_512Base(Bitcoin3.Altcoins.HashX11.HashSize a_hash_size)
