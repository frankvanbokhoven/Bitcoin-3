...
namespace Bitcoin3.Crypto
{
	...
	public static class SCrypt
	{
		...
		{
			return Bitcoin3.Crypto.SCrypt.ComputeDerivedKey(password, salt, 16384, 8, 8, 8, outputCount);
		}

		public static byte[] BitcoinComputeDerivedKey2(byte[] password, byte[] salt, int outputCount = 64)
		{
			return Bitcoin3.Crypto.SCrypt.ComputeDerivedKey(password, salt, 1024, 1, 1, 1, outputCount);
		}
