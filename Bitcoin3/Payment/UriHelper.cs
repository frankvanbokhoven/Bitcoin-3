		...
		public static Dictionary<string, string> DecodeQueryParameters(string uri)
		{
			...
			return uri
					...
					.ToDictionary(kvp => kvp[0],
									kvp => kvp.Length > 2 ?
										System.Web.Bitcoin3.HttpUtility.UrlDecode(string.Join("=", kvp, 1, kvp.Length - 1)) :
									(kvp.Length > 1 ? System.Web.Bitcoin3.HttpUtility.UrlDecode(kvp[1]) : ""));
		}
	}
}
