...
namespace Bitcoin3
{
	...
	{
		static readonly TransactionSignature _Empty = new TransactionSignature(new ECDSASignature(Bitcoin3.BouncyCastle.Math.BigInteger.ValueOf(0), Bitcoin3.BouncyCastle.Math.BigInteger.ValueOf(0)), SigHash.All);
